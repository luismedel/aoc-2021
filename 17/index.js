...
let solutions = bruteForce (S, area, 5000);

let max = 0;

// Each probe starting with a positive vy velocity will reach the top point (vy*(vy+1))/2 at vy steps
for (let i = 0; i < solutions.length; i++)
{
	let vx = solutions[i][0],
		vy = solutions[i][1],
		maxY = (vy*(vy+1))/2 | 0;
